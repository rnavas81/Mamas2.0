                ...
                <div class="row">
                    ...
                    <div class="col-md-12 col-lg-6 pb-5">
                        <div class="container">
                            ...
                            <form class="needs-validation text-center border border-light mt-5 p-5 white" id="formRegistro" name="formRegistro" action="<?= CTRL_USUARIOS ?>" method="POST" novalidate>
                                <div></div>
                                ...
                                <div>
                                    ...
                                    <a class="btn btn-block primary-color white-text" href="<?= WEB_INDEX ?>">
                                        Volver
                                    <a/>
                                </div>
